...
func initialize() []byte {
	...
	samlProvider, metadata, err := gothsaml.New(spKeypair.Leaf, spKeypair.PrivateKey.(*rsa.PrivateKey), idpMetadata, "http://localhost:8080/saml/metadata", "http://localhost:8080/saml/acs", "http://localhost:8080/saml/slo")
	if err != nil {
		log.Fatal(err)
	}
